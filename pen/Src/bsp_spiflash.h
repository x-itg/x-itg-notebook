...
#define FLASH_SPI_CS_ENABLE()                      (GPIOA->BRR=(1<<4))  //HAL_GPIO_WritePin(FLASH_SPI_CS_PORT, FLASH_SPI_CS_PIN, GPIO_PIN_RESET)
#define FLASH_SPI_CS_DISABLE()                     (GPIOA->BSRR=(1<<4)) //HAL_GPIO_WritePin(FLASH_SPI_CS_PORT, FLASH_SPI_CS_PIN, GPIO_PIN_SET)
#define SPI_FLASH_SECTOR_SIZE    4096    // 串行Flash扇区大小
#define SPI_FLASH_SECTOR_COUNT   0x800    // 串行Flash文件系统FatFS占用扇区个数   
/* 扩展变量 ------------------------------------------------------------------*/
