...
#pragma inline
        static float inv_q30_to_float(long q30)
    {
        return (float) q30 / ((float)(1L << 30));
    }
#endif
...
#elif defined ( __ICCARM__ ) // 使用IAR编译环境
#pragma inline
        static  double inv_q30_to_double(long q30)
    {
        return (double) q30 / ((double)(1L << 30));
    }
#endif
...
#elif defined ( __ICCARM__ ) // 使用IAR编译环境
#pragma inline
        static  float inv_q16_to_float(long q16)
    {
        return (float) q16 / (1L << 16);
    }
#endif
...
#elif defined ( __ICCARM__ ) // 使用IAR编译环境
#pragma inline
    static  double inv_q16_to_double(long q16)
    {
        return (double) q16 / (1L << 16);
    }
#endif
    ...
    #elif defined ( __ICCARM__ ) // 使用IAR编译环境
    #pragma inline
        static long inv_delta_time_ms(inv_time_t t1, inv_time_t t2)
    {
        return (long)((t1 - t2));
    }
    #endif
